...
$next=($k!=(count($rs)-1))?$rs[$k+1]['id']:$r['id'];
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" data-rank="<?=$r['id']."-".$next;?>">往下</button>
                <select name="ani[]">
            ...
            <td>
                <input type="checkbox" name="sh[]" value="<?=$r['id'];?>" <?=$c;?>>
...
<form action="api/add_poster.php" method="post" enctype="multipart/form-data">
    ...
    <div>
        預告片海報 <input type="file" name="path" id="path">
    </div>
    <div>
